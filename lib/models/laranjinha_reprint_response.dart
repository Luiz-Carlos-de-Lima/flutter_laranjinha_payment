...
class LaranjinhaReprintResponse {
  final LaranjinhaStatusDeeplink code;
  final String message;

  LaranjinhaReprintResponse({required this.code, required this.message});

  factory LaranjinhaReprintResponse.fromJson(Map<String, dynamic> json) {
    return LaranjinhaReprintResponse(code: _statusFromString(json['code']), message: json['message']);
  }
